                                ...
                                <tbody>
                                    <tr v-for="cart in carts" :key="cart.id">
                                        ...
                                        <td class="b-none text-right">
                                            <p class="m-0 fw-bold">Rp. {{ moneyFormat(cart.price) }}
                                            </p>
                                            <p class="m-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class=" border-0 text-right">
                                            <p class="fw-bold m-0 h5" align="right">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">                            
                                ...
                                <div class="form-group" v-if="state.courier">
                                    ...
                                    <br>              
                                        <div class="form-check form-check-inline">                       
                                            <input class="form-check-input select-courier me-1" type="radio" name="courier"
                                                id="ongkos_kirim-tiki" value="tiki" v-model="state.courier_type" @change="getOngkir" style="cursor: pointer">
                                            <label class="form-check-label fw-bold me-2"
                                                for="ongkos_kirim-tiki" style="cursor: pointer">TIKI</label>
                                        </div>
                                        <div class="form-check form-check-inline">      
                                            <input class="form-check-input select-courier me-1" type="radio" name="courier"
                                                id="ongkos_kirim-pos" value="pos" v-model="state.courier_type" @change="getOngkir" style="cursor: pointer">
                                            <label class="form-check-label fw-bold" for="ongkos_kirim-pos" style="cursor: pointer">POS</label>
                                        </div>                                   
                                </div>
                            </div>
                            <div class="col-md-12 mt-2">
                                <div class="form-group" v-if="state.cost">
                                    ...
                                    <div v-for="value in state.costs" :key="value.service" class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="cost" :id="value.service"
                                            ...
                                            @change="getCostService" style="cursor: pointer">
                                        <label class="form-check-label font-weight-normal me-5" :for="value.service" style="cursor: pointer">
                            ...
                            <div v-if="state.buttonCheckout" class="col-md-12 mt-3">
                                <button @click.prevent="checkout" class="btn btn-primary btn-lg w-100">Checkout</button>
                            </div>
                        </div>
                    </div>
                </div>
